...
public class AVLMap <K, V> implements SimpleMap<K, V> {
    ...
    private void initiateSet () {
        set = new AVLSet<>(new Comparator<Node<K, V>>() {
            @Override public int compare (Node<K, V> o1, Node<K, V> o2) {
    ...
    @Override public Iterator<K> keyIterator () {
        ValueGetter<K> getter = new ValueGetter<K>() {
            @Override public K getValue (Node<K, V> n) {
                return n.key;
            }
        };
    ...
    @Override public Iterator<V> valueIterator () {
        ValueGetter<V> getter = new ValueGetter<V>() {
            @Override public V getValue (Node<K, V> n) {
                return n.value;
            }
        };
    ...
    @Override public AVLSet<K> keySet () {
