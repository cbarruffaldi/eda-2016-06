...
public class BinaryMinHeap <T> implements PriorityQueue<T> {
    ...
    private static class PQNode <T> implements Comparable<PQNode<T>> {
        ...
        @Override public int compareTo (PQNode<T> o) {
