...
public class Parser {
    ...
    private static boolean hasEnded = false;
        // Dice si usaron el comando exitAndClose. Pensar mejor solución.
    ...
    private static List<Airport> findPathWithOption (String option, String orig, String dest,
        List<Day> days) {
    ...
    private static boolean flightInsert (Scanner sc) {
        ...
        flightAssistant
            .insertFlight(airline, flnumber, price, departures, new Time(duration), orig, dest);
        return true;
    }
